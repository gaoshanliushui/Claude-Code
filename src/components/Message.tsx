	...
	switch (message.type) {
		case "attachment": {
			...
			if ($[0] !== addMargin || $[1] !== isTranscriptMode || $[2] !== message.attachment || $[3] !== verbose) {
				t2 = <AttachmentMessage addMargin={addMargin} attachment={message.attachment} verbose={verbose}
			...
			if ($[5] !== addMargin || $[6] !== commands || $[7] !== inProgressToolUseIDs || $[8] !== isTranscriptMode || $[9] !== lastThinkingBlockId || $[10] !== lookups || $[11] !== message.advisorModel || $[12] !== message.message.content || $[13] !== message.uuid || $[14] !== onOpenRateLimitOptions || $[15] !== progressMessagesForMessage || $[16] !== shouldAnimate || $[17] !== shouldShowDot || $[18] !== tools || $[19] !== verbose || $[20] !== width) {
				...
				if ($[22] !== addMargin || $[23] !== commands || $[24] !== inProgressToolUseIDs || $[25] !== isTranscriptMode || $[26] !== lastThinkingBlockId || $[27] !== lookups || $[28] !== message.advisorModel || $[29] !== message.uuid || $[30] !== onOpenRateLimitOptions || $[31] !== progressMessagesForMessage || $[32] !== shouldAnimate || $[33] !== shouldShowDot || $[34] !== tools || $[35] !== verbose || $[36] !== width) {
					t4 = (_, index_0) => <AssistantMessageBlock key={index_0} param={_} addMargin={addMargin}
					                                            tools={tools} commands={commands} verbose={verbose}
					                                            inProgressToolUseIDs={inProgressToolUseIDs}
					                                            progressMessagesForMessage={progressMessagesForMessage}
					                                            shouldAnimate={shouldAnimate}
					                                            shouldShowDot={shouldShowDot} width={width}
					                                            inProgressToolCallCount={inProgressToolUseIDs.size}
					                                            isTranscriptMode={isTranscriptMode} lookups={lookups}
		...
		case "user": {
			...
			if ($[47] !== addMargin || $[48] !== imageIndices || $[49] !== isTranscriptMode || $[50] !== isUserContinuation || $[51] !== lookups || $[52] !== message || $[53] !== progressMessagesForMessage || $[54] !== style || $[55] !== tools || $[56] !== verbose) {
				t3 = message.message.content.map((param_0, index) => <UserMessage key={index} message={message}
				                                                                  addMargin={addMargin} tools={tools}
				                                                                  progressMessagesForMessage={progressMessagesForMessage}
				                                                                  param={param_0} style={style}
				                                                                  verbose={verbose}
		...
		case "system": {
			...
			if (message.subtype === "local_command") {
				...
				if ($[70] !== addMargin || $[71] !== isTranscriptMode || $[72] !== t2 || $[73] !== verbose) {
					t3 = <UserTextMessage addMargin={addMargin} param={t2} verbose={verbose}
					                      isTranscriptMode={isTranscriptMode}/>;
					$[70] = addMargin;
					$[71] = isTranscriptMode;
					$[72] = t2;
			...
			if ($[75] !== addMargin || $[76] !== isTranscriptMode || $[77] !== message || $[78] !== verbose) {
				t2 = <SystemTextMessage message={message} addMargin={addMargin} verbose={verbose}
				                        isTranscriptMode={isTranscriptMode}/>;
				$[75] = addMargin;
				$[76] = isTranscriptMode;
				$[77] = message;
		...
		case "grouped_tool_use": {
			...
			if ($[80] !== inProgressToolUseIDs || $[81] !== lookups || $[82] !== message || $[83] !== shouldAnimate || $[84] !== tools) {
				t2 = <GroupedToolUseContent message={message} tools={tools} lookups={lookups}
				                            inProgressToolUseIDs={inProgressToolUseIDs} shouldAnimate={shouldAnimate}/>;
		...
		case "collapsed_read_search": {
			...
			if ($[86] !== inProgressToolUseIDs || $[87] !== isActiveCollapsedGroup || $[88] !== lookups || $[89] !== message || $[90] !== shouldAnimate || $[91] !== t2 || $[92] !== tools) {
				t3 = <OffscreenFreeze><CollapsedReadSearchContent message={message}
				                                                  inProgressToolUseIDs={inProgressToolUseIDs}
				                                                  shouldAnimate={shouldAnimate} verbose={t2}
				                                                  tools={tools} lookups={lookups}
				                                                  isActiveGroup={isActiveCollapsedGroup}/></OffscreenFreeze>;
	...
	switch (param.type) {
		case "text": {
			...
			if ($[0] !== addMargin || $[1] !== isTranscriptMode || $[2] !== message.planContent || $[3] !== message.timestamp || $[4] !== param || $[5] !== verbose) {
				t1 = <UserTextMessage addMargin={addMargin} param={param} verbose={verbose}
				                      planContent={message.planContent} isTranscriptMode={isTranscriptMode}
		...
		case "tool_result": {
			...
			if ($[10] !== isTranscriptMode || $[11] !== lookups || $[12] !== message || $[13] !== param || $[14] !== progressMessagesForMessage || $[15] !== style || $[16] !== t1 || $[17] !== tools || $[18] !== verbose) {
				t2 = <UserToolResultMessage param={param} message={message} lookups={lookups}
				                            progressMessagesForMessage={progressMessagesForMessage} style={style}
				                            tools={tools} verbose={verbose} width={t1}
				                            isTranscriptMode={isTranscriptMode}/>;
				$[10] = isTranscriptMode;
				$[11] = lookups;
				$[12] = message;
	...
	if (feature("CONNECTOR_TEXT")) {
		if (isConnectorTextBlock(param)) {
			...
			if ($[2] !== addMargin || $[3] !== onOpenRateLimitOptions || $[4] !== shouldShowDot || $[5] !== t1 || $[6] !== verbose || $[7] !== width) {
				t2 = <AssistantTextMessage param={t1} addMargin={addMargin} shouldShowDot={shouldShowDot}
	...
	switch (param.type) {
		case "tool_use": {
			...
			if ($[9] !== addMargin || $[10] !== commands || $[11] !== inProgressToolCallCount || $[12] !== inProgressToolUseIDs || $[13] !== isTranscriptMode || $[14] !== lookups || $[15] !== param || $[16] !== progressMessagesForMessage || $[17] !== shouldAnimate || $[18] !== shouldShowDot || $[19] !== tools || $[20] !== verbose) {
				t1 = <AssistantToolUseMessage param={param} addMargin={addMargin} tools={tools} commands={commands}
				                              verbose={verbose} inProgressToolUseIDs={inProgressToolUseIDs}
				                              progressMessagesForMessage={progressMessagesForMessage}
				                              shouldAnimate={shouldAnimate} shouldShowDot={shouldShowDot}
				                              inProgressToolCallCount={inProgressToolCallCount} lookups={lookups}
				                              isTranscriptMode={isTranscriptMode}/>;
				$[9] = addMargin;
				$[10] = commands;
		...
		case "text": {
			...
			if ($[22] !== addMargin || $[23] !== onOpenRateLimitOptions || $[24] !== param || $[25] !== shouldShowDot || $[26] !== verbose || $[27] !== width) {
				t1 = <AssistantTextMessage param={param} addMargin={addMargin} shouldShowDot={shouldShowDot}
				                           verbose={verbose} width={width}
				                           onOpenRateLimitOptions={onOpenRateLimitOptions}/>;
				$[22] = addMargin;
		...
		case "thinking": {
			...
			if ($[31] !== addMargin || $[32] !== isTranscriptMode || $[33] !== param || $[34] !== t1 || $[35] !== verbose) {
				t2 = <AssistantThinkingMessage addMargin={addMargin} param={param} isTranscriptMode={isTranscriptMode}
				                               verbose={verbose} hideInTranscript={t1}/>;
				$[31] = addMargin;
				$[32] = isTranscriptMode;
				$[33] = param;
				$[34] = t1;
		...
		case "advisor_tool_result": {
			if (isAdvisorBlock(param)) {
				...
				if ($[37] !== addMargin || $[38] !== advisorModel || $[39] !== lookups.erroredToolUseIDs || $[40] !== lookups.resolvedToolUseIDs || $[41] !== param || $[42] !== shouldAnimate || $[43] !== t1) {
					t2 = <AdvisorMessage block={param} addMargin={addMargin}
					                     resolvedToolUseIDs={lookups.resolvedToolUseIDs}
					                     erroredToolUseIDs={lookups.erroredToolUseIDs} shouldAnimate={shouldAnimate}
					                     verbose={t1} advisorModel={advisorModel}/>;
					$[37] = addMargin;
					$[38] = advisorModel;
