...
export function registerLoopSkill(): void {
	registerBundledSkill({
		...
		whenToUse:
			'When the user wants to set up a recurring agent, poll for status, or run something repeatedly on an interval (e.g. "check the deploy every 5 minutes", "keep running /babysit-prs"). Do NOT invoke for one-off tasks.',
