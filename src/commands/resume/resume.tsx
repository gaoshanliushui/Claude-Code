...
function ResumeCommand({
	...
	async function handleSelect(log: LogOption) {
		...
		if (crossProjectCheck.isCrossProject) {
			...
			const crossCmd = (crossProjectCheck as {
				isCrossProject: true;
	...
	return <LogSelector logs={logs} maxHeight={insideModal ? Math.floor(rows / 2) : rows - 2} onCancel={handleCancel}
	                    onSelect={handleSelect} onLogsChanged={() => loadLogs(showAllProjects, worktreePaths)}
